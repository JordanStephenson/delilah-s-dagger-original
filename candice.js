...
if(galleryImages) {
    galleryImages.forEach(function(image,index) {
        image.addEventListener('click', () => {
            ...
            let getImgUrlPos = getFullImgUrl.split('IMG/candice-img');
            ...
            newImg.setAttribute('src', 'IMG/candice-img' + setNewImgUrl);
...
function changeImg(changeDir) {
    ...
    newImg.setAttribute('src', 'IMG/candice-img/candice-img' + calcNewImg + '.png');
    newImg.setAttribute('id', 'current-img');
